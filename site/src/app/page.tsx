...
export default function Home() {
  return (
    <>
      ...
      {/* ==================== HERO ==================== */}
      <section className="relative flex min-h-svh flex-col items-center justify-start sm:justify-center overflow-hidden px-4 pb-12 sm:px-6 sm:pb-16" style={{ paddingTop: 'calc(72px + env(safe-area-inset-top))' }}>
